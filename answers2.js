    ...
    function play(dir){
        ...
        switch(id){
            ...
            case "left2":
                ...
                break;
			case "up3":
                buildDir(gender, "needrestroom.mp3");
                audio = new Audio(file);
                break;
            case "down3":
                buildDir(gender, "needdrink.mp3");
                audio = new Audio(file);
                break;
			case "right3":
                buildDir(gender, "needbreak.mp3");
                audio = new Audio(file);
                break;
            case "left3":
                buildDir(gender, "ineedhelp.mp3");
                audio = new Audio(file);
                break;
			case "up4":
                buildDir(gender, "yestrue.mp3");
                audio = new Audio(file);
                break;
            case "down4":
                buildDir(gender, "nofalse.mp3");
                audio = new Audio(file);
                break;
			case "right4":
                buildDir(gender, "thankyou.mp3");
                audio = new Audio(file);
                break;
            case "left4":
                buildDir(gender, "idontknow.mp3");
                audio = new Audio(file);
                break;
        }
        audio.play();
